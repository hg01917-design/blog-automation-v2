...
def generate_text(prompt: str, blog_id: str = None, keyword: str = None,
    ...
    _BOLD_RULE = (
        ...
        "제목에 '완벽가이드', '완벽정리', '완벽정복', '완벽 가이드', '완벽 정리', '완벽 정복', '마이리얼트립' 등 마케팅 문구 절대 금지.\n"
        "예) X: '제주도 3박4일 완벽 가이드'\n"
        "예) O: '제주도 3박4일 여행 일정 짜는 법'\n"
    ...
    _FORMAT_RULE = (
        "\n\n[제목 규칙 — 필수]\n"
        "===제목=== 안의 제목에 '완벽가이드', '완벽정리', '완벽정복', '완벽 가이드', '완벽 정리', '완벽 정복', '마이리얼트립' 절대 금지.\n"
        "제목은 검색 키워드처럼 간결하게: 예) '제주도 3박4일 뚜벅이 여행 코스'\n"
        "\n[본문 형식 규칙 — 필수]\n"
