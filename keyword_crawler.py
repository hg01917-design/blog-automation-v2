...
BLOG_CATEGORIES = {
    ...
    "baremi542": [
        ...
        # 세금 환급/신고
        "종합소득세 환급", "종합소득세 신고방법", "5월 연말정산 방법",
        "중도퇴사자 연말정산", "연말정산 누락 환급", "경정청구 신청방법",
        # 복지 수당
...
def _is_season_valid(keyword: str, month: int = None) -> bool:
    ...
    if "연말정산" in keyword and month == 5:
        return any(term in keyword for term in MAY_TAX_INTENT)
