"""salim1su 에어컨 필터 청소 포스팅 — Gemini 이미지 + 네이버 임시저장"""
import re, sys, os
...
DRAFT_PATH = "/tmp/salim1su_draft.txt"
KEYWORD = "에어컨 필터 청소 주기 직접 하는 법"
...
bing_infos = [
    {"index": info["index"], "prompt": info["prompt"],
     "filename": f"salim1su_aircon_{info['index']}.jpg", "alt": info["alt"]}
